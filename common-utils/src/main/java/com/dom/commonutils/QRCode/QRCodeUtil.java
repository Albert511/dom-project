...
public class QRCodeUtil {
     ...
     * @param imgPath      要嵌入二维码的图片路径，如果不写或者为null则生成一个没有嵌入图片的纯净的二维码
     * @param destPath     生成的二维码的存放路径
     * @param needCompress 表示将嵌入二维码的图片进行压缩，如果为“false”则表示不压缩。
     * @throws Exception
     */
